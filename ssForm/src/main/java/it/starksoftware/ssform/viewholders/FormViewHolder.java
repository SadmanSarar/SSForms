...
public class FormViewHolder extends RecyclerView.ViewHolder {
	...
	public FormViewHolder(View v, FormCustomEditTextListener listener, FormCustomEditTextInputLayoutListener listenerInputLayout, int viewType, FormCustomEditMemoTextListener memoTextListener) {
		super(v);
